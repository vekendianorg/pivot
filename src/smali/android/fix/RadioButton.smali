.class public Landroid/fix/RadioButton;
...
.method public invalidateDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 64
    :try_start_0
    invoke-super {p0, p1}, Landroid/widget/RadioButton;->invalidateDrawable(Landroid/graphics/drawable/Drawable;)V
    :try_end_0
...
.method public onDragEvent(Landroid/view/DragEvent;)Z
    ...
    .line 140
    :try_start_0
    invoke-super {p0, p1}, Landroid/widget/RadioButton;->onDragEvent(Landroid/view/DragEvent;)Z
    :try_end_0
...
.method public onKeyShortcut(ILandroid/view/KeyEvent;)Z
    ...
    .line 160
    :try_start_0
    invoke-super {p0, p1, p2}, Landroid/widget/RadioButton;->onKeyShortcut(ILandroid/view/KeyEvent;)Z
    :try_end_0
    .catch Ljava/lang/NullPointerException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onTextContextMenuItem(I)Z
    ...
    .line 170
    :try_start_0
    invoke-super {p0, p1}, Landroid/widget/RadioButton;->onTextContextMenuItem(I)Z
    :try_end_0
    .catch Ljava/lang/NullPointerException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public performLongClick()Z
    ...
    .line 119
    :try_start_0
    invoke-super {p0}, Landroid/widget/RadioButton;->performLongClick()Z
    :try_end_0
    .catch Ljava/lang/ClassCastException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public playSoundEffect(I)V
    ...
    .line 101
    :try_start_0
    invoke-super {p0, p1}, Landroid/widget/RadioButton;->playSoundEffect(I)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public refreshDrawableState()V
    ...
    .line 82
    :try_start_0
    invoke-super {p0}, Landroid/widget/RadioButton;->refreshDrawableState()V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public sendAccessibilityEvent(I)V
    ...
    .line 110
    :try_start_0
    invoke-super {p0, p1}, Landroid/widget/RadioButton;->sendAccessibilityEvent(I)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
